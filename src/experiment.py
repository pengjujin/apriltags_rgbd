...
rgb_image = cv2.imread("../experiment/test_data/rgb_frame.png")
depth_image = cv2.imread("../experiment/test_data/depth_frame.png", cv2.IMREAD_ANYDEPTH)
